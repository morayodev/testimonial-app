      ...
      <div className="HeroReview">
        <div className="row flex-column-reverse flex-md-row">
          ...
          <div className="col-12 col-md-5">
            <div className="HeroReviewText py-5 px-4">
              ...
              <p>
                ...
                service, an all round great experience. I would definately be coming back! I had the best experience
                shopping with vasiti. Usability of the website was great, very good customer service, an all round great
